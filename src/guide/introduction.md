...
Los componentes de Vue se pueden crear en dos tipos de API diferentes: **Options API** y **Composition API**.
...
export default {
  ...
  // Los ciclos de vida de los hooks son llamados en diferentes
